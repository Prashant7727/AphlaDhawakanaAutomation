...
public class UploadVerificationStaff {

	@Test
	public void UploadVerificationStaff () {
...
//        // Wait for the error message to be displayed
		...
		WebElement UploadVerificationStaff = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"managePaymentStaff\"]")));
		...
		driver.findElement(By.id("shr")).click();
