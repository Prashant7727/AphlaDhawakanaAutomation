...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement PatientTestReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"PatientTestReport\"]")));
		PatientTestReport.click();
		...
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/div[4]/div[2]/div/div/input")).click();
