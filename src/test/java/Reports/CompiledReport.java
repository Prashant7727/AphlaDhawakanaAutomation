...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement compiledReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"compileConsultDiagReport\"]")));
		compiledReport.click();
