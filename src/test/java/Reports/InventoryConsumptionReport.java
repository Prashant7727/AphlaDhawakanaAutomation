...
@Test
	public void InventoryConsumptionReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement InventoryConsumptionReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"inventoryConsumptionReport\"]")));
		InventoryConsumptionReport.click();
