...
public class PatientPrescriptionReport {
@Test
	public void PatientPrescriptionReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement PatientPrescriptionReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"PatientPrescriptionReport\"]")));
		PatientPrescriptionReport.click();
		...
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/div[4]/div[2]/input")).click();
