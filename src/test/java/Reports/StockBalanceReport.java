...
@Test
	public void StockBalanceReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement StockBalanceReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"stockReportAamc\"]")));
		StockBalanceReport.click();
		...
		driver.findElement(By.xpath("//*[@id=\"isClinic\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"isClinic\"]/option[2]")).click();

		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/div[5]/div[2]/div[2]/div[2]/input")).click();
