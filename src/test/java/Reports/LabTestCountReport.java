...
public class LabTestCountReport {
@Test
	public void LabTestCountReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement LabTestCountReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"labTestCountReport\"]")));
		LabTestCountReport.click();

		// Lab Test Count Report--------------------------
