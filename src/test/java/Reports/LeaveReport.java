...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement LeaveReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"LeaveApprovedReport\"]")));
		LeaveReport.click();

		// Leave report-----------------------------------------

		driver.findElement(By.xpath("//*[@id=\"startDate\"]")).clear();
		driver.findElement(By.xpath("//*[@id=\"startDate\"]")).sendKeys("01/01/2020");

		driver.findElement(By.xpath("//*[@id=\"endDate\"]")).clear();
		driver.findElement(By.xpath("//*[@id=\"endDate\"]")).sendKeys("18/07/2023");
