...
public class LoopClosureReport {
@Test
	public void LoopClosureReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement LoopClosureReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"referralCloserReport\"]")));
		LoopClosureReport.click();
