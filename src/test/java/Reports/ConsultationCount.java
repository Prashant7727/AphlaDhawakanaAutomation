...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement ConsultationCount = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"consultationReport\"]")));
		ConsultationCount.click();
		...
		driver.findElement(By.xpath("//*[@id=\"daysFollowUp\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"daysFollowUp\"]/option[3]")).click();

		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[4]/label[1]")).click();

		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[4]/div[2]/div[2]/input[1]")).click();
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[4]/div[2]/div[2]/input[2]")).click();

		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[4]/label[2]")).click();
