...
public class DoctorsHubReport {
@Test
	public void DoctorsHubReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement DoctorsHubReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"doctorHubReport\"]")));
		DoctorsHubReport.click();
		...
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[3]/div[2]/input")).click();
