...
public class StaffAttendenceDetailReport {
@Test
	public void StaffAttendenceDetailReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement StaffAttendenceDetailReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"staffAttendenceDetailReport\"]")));
		StaffAttendenceDetailReport.click();
