...
public class ThaneBillingReport {
@Test
	public void ThaneBillingReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement ThaneBillingReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ThaneBillingReport\"]")));
		ThaneBillingReport.click();

		// Thane Billing Report----------------------
