...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement CostReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"billingReport\"]")));
		CostReport.click();

		// Cost report-----------------------------------------

//        driver.findElement(By.xpath("//*[@id=\"startDate\"]")).clear();
//        driver.findElement(By.xpath("//*[@id=\"startDate\"]")).sendKeys("18/07/2020");
//        
