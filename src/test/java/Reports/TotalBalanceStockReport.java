...
public class TotalBalanceStockReport {
@Test
	public void TotalBalanceStockReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement TotalBalanceStockReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"inventoryStockReport\"]")));
		TotalBalanceStockReport.click();
...
//		driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/table/tbody/tr[1]/td[7]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/div[5]/input")).click();
