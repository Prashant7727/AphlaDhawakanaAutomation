...
public class MedicineDispenceReport {
 @Test
	public void MedicineDispenceReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement InstituteInventoryReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"MedicineDispenceReport\"]")));
		InstituteInventoryReport.click();
