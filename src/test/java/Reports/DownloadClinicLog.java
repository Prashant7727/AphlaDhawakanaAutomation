...
public class DownloadClinicLog {
@Test
	public void DownloadClinicLog() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement DownloadClinicLog = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"viewAamcLog\"]")));
		DownloadClinicLog.click();
