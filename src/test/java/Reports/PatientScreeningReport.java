...
public class PatientScreeningReport {
@Test
	public void PatientScreeningReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement PatientScreeningReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"patientScreeningReport\"]")));
		PatientScreeningReport.click();
		...
		driver.findElement(By.xpath("//*[@id=\"myselection\"]/option[1]")).click();
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/label")).click();
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div/div[4]/div/div[2]/div[2]/input")).click();
